...
export const PetForm: FC<Props> = ({ onSave, onCancel, id }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={style.Container} noValidate>
      <div className={style.Form}>
        ...
        <div className={style.SelectorContainer}>
          <FormControl className={style.FormControl} error={Boolean(errors.kind)}>
          ...
          <FormControl error={Boolean(errors.gender)} className={style.FormControl}>
          ...
          <FormControl error={Boolean(errors.size)} className={style.FormControl}>
                ...
                return (
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField aria-labelledby="birthdate-labe" {...params} />
                      )}
                    />
